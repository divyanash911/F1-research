...
# ══════════════════════════════════════════════════════════════════════════════
@tool("Analyze Race Lap Times and Pace")
...
# ══════════════════════════════════════════════════════════════════════════════
@tool("Analyze Tyre Strategy and Degradation")
...
# ══════════════════════════════════════════════════════════════════════════════
@tool("Deep Qualifying Session Analysis")
...
# ══════════════════════════════════════════════════════════════════════════════
@tool("Analyze Weather and Track Conditions")
...
# ══════════════════════════════════════════════════════════════════════════════
@tool("Analyze Driver vs Team Mate Performance")
...
# ══════════════════════════════════════════════════════════════════════════════
@tool("Sector-by-Sector Lap Time Breakdown")
...
# ══════════════════════════════════════════════════════════════════════════════
@tool("Analyze Car Speed Trap and Power Unit Performance")
...
# ══════════════════════════════════════════════════════════════════════════════
@tool("Get Championship Standings and Points Analysis")
...
# ══════════════════════════════════════════════════════════════════════════════
@tool("Execute Python Code for Custom F1 Analysis")
...
# ══════════════════════════════════════════════════════════════════════════════
@tool("Detect Statistical Patterns in F1 Data")
...
# ══════════════════════════════════════════════════════════════════════════════
@tool("Get F1 Circuit Profile and Characteristics")
...
# ══════════════════════════════════════════════════════════════════════════════
@tool("Get F1 Driver and Team Lineup")
